...
.. container:: table-row
   ...
   Description
         ...
         configuration of extensions. (\_CSS\_DEFAULT\_STYLE outputs a set
         of default styles, just because an extension is installed.)
...
.. container:: table-row
   ...
   Description
         (Since TYPO3 6.1) Remove CSS generated by \_CSS\_PAGE\_STYLE
         configuration of extensions. (\_CSS\_PAGE\_STYLE renders certain
         styles not just because an extension is installed, but only in a
         special situation. E.g. some styles will be output, when a textpic
         element with an image positioned alongside the text is present on
         the current page.)
