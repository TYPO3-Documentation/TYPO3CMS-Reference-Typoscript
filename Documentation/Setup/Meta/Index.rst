...
:aspect:`Description:`
   ...
   :aspect:`replace:`
      If set to 1, the tag will replace the one set earlier by a plugin. If set to 0 (default), the meta tag generated
      by the plugin will be used. If there is none yet, the one from TypoScript is set.
